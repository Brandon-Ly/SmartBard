const data = [
    {
        ...
        body: `Enjoy your extra hour of sleep this weekend, but don’t forget to turn back your clocks when you rise and shine Sunday morning.
    ...
    {
        title: "Dummy 4",
        body: `Generating random paragraphs can be an excellent way for writers to get their creative flow going at the beginning of the day. 
    ...
    {
        title: "Dummy 5",
        body: `A second option is to use the random paragraph somewhere in a short story they create. 
    ...
    {
        title: "Dummy 6",
        body: `A random paragraph can also be an excellent way for a writer to tackle writers' block. 
    ...
    },
    {
        ...
        One way is to generate a random paragraph with the intention to try to rewrite it while still keeping the original meaning. 
    ...
    {
        title: "Dummy 8",
        body: `It's not only writers who can benefit from this free online tool. 
        If you're a programmer who's working on a project where blocks of text are needed, 
